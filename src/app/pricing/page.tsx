    ...
    <div className="min-h-screen bg-black">
      ...
      {user && (
        <div className="absolute top-4 right-4 z-50">
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm text-white hover:text-white hover:bg-white/20 rounded-xl border border-white/20 shadow-sm transition-all"
          >
            <LogOut size={18} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {PLANS.map((plan, index) => (
            <motion.div
              ...
              className={`
                bg-slate-900/50 backdrop-blur-sm rounded-2xl shadow-lg border-2 p-8 relative
                ${plan.popular
              ...
              <button
                ...
                className={`
                  ...
                  ${plan.popular
                    ...
                    : 'bg-white/10 text-white hover:bg-white/20 disabled:opacity-70'
                  }
                `}
              >
                {loadingPlan === plan.id ? (
        ...
        <motion.div
          ...
          className="bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-white/10 p-8 max-w-4xl mx-auto"
        >
