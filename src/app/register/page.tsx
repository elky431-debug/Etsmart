      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-semibold text-white/90 mb-2">Nom complet</label>
                  ...
                  {[
                    ...
                    <div key={item.text} className="flex items-center gap-2 text-sm">
                      <div className={`w-4 h-4 rounded-full flex items-center justify-center transition-all ${
                        item.check ? 'bg-[#00d4ff] shadow-sm shadow-[#00d4ff]/30' : 'bg-white/20'
                      }`}>
                        {item.check && <Check size={10} className="text-white" />}
                      </div>
                      <span className={`text-sm transition-colors ${item.check ? 'text-[#00d4ff] font-medium' : 'text-white/50'}`}>
                        {item.text}
                      </span>
                    </div>
                  ))}
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <input 
                type="checkbox" 
                className="w-4 h-4 mt-0.5 rounded border-white/30 bg-white/5 text-[#00d4ff] focus:ring-[#00d4ff] focus:ring-2 cursor-pointer" 
                required
              />
