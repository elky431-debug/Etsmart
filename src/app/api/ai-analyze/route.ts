...
- 0-80 boutiques: "non_sature" → LANCER (lancer rapidement, pas de concurrence)
- 81-130 boutiques: "concurrentiel" → LANCER_CONCURRENTIEL (peut être lancé mais il faut tout optimiser car il y a de la concurrence)
