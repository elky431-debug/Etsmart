-- Ajouter 30 crédits à inizanmathis32@gmail.com
...
FROM users
WHERE email = 'inizanmathis32@gmail.com';
...
-- 3. Si l’UPDATE a touché 0 ligne, l’email n’existe pas dans public.users (vérifier auth.users / orthographe).
-- 4. Vérification
SELECT
  id,
  email,
